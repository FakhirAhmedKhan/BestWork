...
export const Badge = ({ Icon, BageName ,count}) => {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className="group  relative inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border border-fuchsia-200/50 dark:border-fuchsia-800/50 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden cursor-pointer"
    >
